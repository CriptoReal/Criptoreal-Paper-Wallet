ninja.wallets.bulkwallet = {
	...
	// rowLimit: number of Criptoreal Addresses to generate
	// startIndex: add this number to the row index for output purposes
	// returns:
	// index,criptorealAddress,privateKeyWif
