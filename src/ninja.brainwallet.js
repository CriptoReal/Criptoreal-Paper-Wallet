	...
	view: function () {
		...
		if (key == keyConfirm || document.getElementById("brainpassphraseshow").checked) {
			...
			if (key.length >= ninja.wallets.brainwallet.minPassphraseLength) {
				...
				var privWif = rvnKey.getCriptorealWalletImportFormat();
				document.getElementById("brainrvnaddress").innerHTML = criptorealAddress;
				document.getElementById("brainrvnprivwif").innerHTML = privWif;
				ninja.qrCode.showQrCode({
					"brainqrcodepublic": criptorealAddress,
