"cs": {
    ...
    "paperlabelcriptorealaddress": "Criptoreal adresa:",
    ...
    "brainalertpassphrasewarning": "Varování: Je důležité zvolit silné heslo, které je odolné proti útoku hrubou silou a krádeži vašich Criptorealů.",
    ...
    "vanityalertinvalidinputcannotmultiple": "Špatný vstup. Dva veřejné klíče není možné násobit. Zvolte 'Přidat' pro přidání dvou veřejných klíčů a získání Criptoreal adresy.",
    ...
    "tagline": "Open Source generátor Criptoreal peněženky napsaný v JavaScript",
    "generatelabelcriptorealaddress": "Generuji Criptoreal adresu",
    ...
    "bulklabelq1": "Proč bych měl používat Hromadnou peněženku pro příjem Criptorealů na mé stránce?",
    "bulka1": "Tradiční způsob jak přijímat Criptorealy na vaší webové stránce vyžaduje instalaci oficiálního criptoreal klienta (\"criptoreald\"). Mnoho webhostingových společností neumožňuje tuto instalaci provést. Také běh criptoreal démona na webovém serveru znamená, že soukromé klíče jsou uloženy na serveru a mohou být ukradeny. Pokud použijete Hromadnou peněženku, tak stačí na server nahrát pouze veřejnou criptoreal adresu a ne soukromé klíče. Poté se nemusíte bát, že vaše Criptorealy budou ukradeny v případě napadení serveru.",
    "bulklabelq2": "Jakým způsobem mohou přijímat Criptorealy na mé stránce pomocí Hromadné peněženky?",
    "bulklabela2li1": "Předgenerujte si velké množství Criptoreal adres (10 000+). Okopírujte si CSV seznam do souboru na bezpečné místo ve vašem počítači. Poté jej vyzálohujte na bezpečné místo.",
    "bulklabela2li2": "Naimportujte Criptoreal adresy do databáze na vašem webovém serveru. Neimportujte soukromé klíče, abyste zabránili krádeži vašich peněz.",
    "bulklabela2li3": "Umožněte na vaší stránce platbu pomocí Criptorealu. Stačí vždy zobrazit jednu z vygenerovaných adres a uložit si ji u objednávky.",
    "bulklabela2li4": "Nyní je již pouze potřeba zařídit notifikace o příchozí transakci. Zadejte do Google \"criptoreal payment notification\" a využijte jednu z existujících služeb. Existuje jich několik a podporují např. Web Services, API, SMS, Email, apod. Notifikaci můžete zpracovat automaticky. Pro ruční kontrolu, zda peníze přišly, stačí použít Block Explorer. Nahraďte SEMPATŘÍADRESA Criptoreal adresou, kterou chcete zkontrolovat. Potvrzení transkace může trvat od 10 minut do jedné hodiny.<br />http://www.blockexplorer.com/address/SEMPATŘÍADRESA<br /><br />Nepotvrzené tansakce je možné zkontrolovat na: http://criptoreal.info/ <br />Většinou se zde zobrazí do 30 sekund.",
    "bulklabela2li5": "Criptorealy budou bezpečně převedeny v řetězci bloků. Pro spotřebování stačí kdykoliv naimportovat soubor vygenerovaný v prvním kroku.",
    ...
    "brainlabelcriptorealaddress": "Criptoreal adresa:",
    ...
    "vanitylabelstep1privnotes": "Zkopírujte a uschovejte uvedený soukromý klíč. Ideálně na šifrovaný disk. Budete ho potřebovat pro získání vašeho Criptoreal soukromého klíče poté, co pool nalezne začátek.",
    ...
    "vanitylabelcriptorealaddress": "Criptoreal adresa Vanity:",
    "vanitylabelnotescriptorealaddress": "Výše je vaše nová adresa, která by měla obsahovat požadovaný začátek.",
    ...
    "detaillabelnote1": "",
    "detaillabelnote2": "",
    "detaillabelcriptorealaddress": "Criptoreal adresa:",
    "detaillabelcriptorealaddresscomp": "Komprimovaná criptoreal adresa:",
