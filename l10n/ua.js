"ua": {
  "choosecurrency": "Оберіть валюту",
    ...
    "donate": "Пожертвувати",
    "generatelabelcriptorealaddress": "Створюється нова адреса...",
    ...
    "singlelabelcriptorealaddress": "Публічна адреса",
    ...
    "brainlabelcriptorealaddress": "Публічна адреса:",
    ...
    "detaillabelcriptorealaddress": "Публічна адреса",
    "detaillabelcriptorealaddresscomp": "Публічна адреса (стиснута)",
    ...
    "footersupport": "Підтримати Criptoreal-paperwallet",
    ...
    "defaultTitle": "Criptoreal-paperwallet - універсальний генератор паперових гаманців для біткойнів та інших криптовалют",
    ...
    "paperwalletback": "<ul><li>Внести гроші на паперовий гаманець: відправте кошти на публічну адресу.</li><li>Перевірити стан рахунку: введіть публічну адресу гаманця в оглядач блокчейна (для біткойна це criptoreal.info).</li><li><b>НІКОЛИ НІКОМУ НЕ ПОКАЗУЙТЕ ПРИВАТНИЙ КЛЮЧ</b>, аж поки ви не зберетесь імпортувати кошти з цього гаманця на інший будь-який гаманець.</li></ul><b>Кількість :</b> ___________      <b>Дата :</b> ____________<br /><b>Нотатки :</b> _______________________________",
},
