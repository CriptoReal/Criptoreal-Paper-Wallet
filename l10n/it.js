"it": {
    ...
    "detailwallet": "Dettagli portafogli",
	  "singletip1": "<b>Un portafogli criptoreal</b> è composto semplicemente da una coppia di valori: l'indirizzo e la sua chiave privata. Un portafogli è stato appena generato sul tuo browser e mostrato sopra.",
    "singletip2": "<b>Per mettere in sicurezza questo portafogli</b> devi stampare o quantomeno salvare l'indirizzo criptoreal e la Chiave privata. È molto importante fare una copia di backup della chiave privata e conservarla in un posto sicuro. Questo sito non conosce la tua chiave privata. Se hai familiarità con PGP, puoi scaricare per intero questa pagina HTML e controllare la sua autentiticità. Puoi confrontare il codice SHA1 della pagina scaricata con il codice firmato dall'autore che trovi nella cronologia delle versioni (in fondo alla pagina). Se abbandoni/aggiorni la pagina web oppure premi il tasto Genera, un nuovo indirizzo sostituirà quello vecchio che non potrà più essere recuperato. La chiave privata dovrebbe essere tenuta segreta, chiunque conosca la chiave privata può avere accesso e spendere i tuoi criptoreal. Se stampi il tuo portafogli conservalo in una busta di plastica sigillata per tenerla al riparo dall'acqua. Tratta quanto stampato alla stregua di una banconota.",
    "singletip3": "<b>Ricevi fondi</b> su questo portafogli mostrando l'indirizzo criptoreal per il versamento.",
    "singletip4": "<b>Controlla il saldo</b> visitando criptoreal.info o blockexplorer.com cercando il tuo indirizzo criptoreal.",
    "singletip5": "<b>Spendi i tuoi criptoreal</b> aprendo un account su criptoreal.info o mtgox.com usando la chiave privata. Puoi anche spendere i tuoi criptoreal scaricando il popolare client p2p ed importando in esso il portafogli. Tieni presente che quando importi una chiave nel client p2p, nel momento in cui spendi le monete, la chiave viene raggruppata insieme alle altre presenti nel programma con i restanti criptoreal. Quando esegui una transazione gli spiccioli verranno invitati verso un altro indirizzo all'interno del tuo portafogli gestito dal client p2p. Quindi dovresti tenere un backup del portafogli contenuto nel client p2p e tenere questo in un posto sicuro fin tanto terrai dei criptoreal lì. Satoshi consiglia di non cancellare mai un portafogli. ",
	"tagline": "Open Source JavaScript Client-Side Multi Coin Wallet Generator",
	"donate": "Supporto",
	"generatelabelcriptorealaddress": "Generazione Indirizzo Criptoreal...",
	...
	"singlelabelcriptorealaddress": "Indirizzo Pubblico",
	...
	"brainlabelcriptorealaddress": "Indirizzo pubblico",
	...
	"detaillabelnote1": "La tua Chiave privata Criptoreal è rappresentata da un numero segreto, unico al mondo, che dovresti conoscere soltanto tu. Può essere codificato in molti formati differenti. Di seguito verrà mostrato l'indirizzo e la chiave pubblica, con la corrispondente chiave privata, nei più diffusi formati di codifica (WIF, WIFC, HEX, B64, MINI).",
	"detaillabelcriptorealaddress": "Indirizzo pubblico",
	"detaillabelcriptorealaddresscomp": "Indirizzo pubblico compresso",
	...
	"footersupport": "Supportare Criptoreal-paperwallet",
	...
	"defaultTitle": "Generatore universale di portafogli per Criptoreal e altre valute crittografiche",
	...
	"paperlabelcriptorealaddress": "Indirizzo Criptoreal:",
    ...
    "vanityalertinvalidinputcannotmultiple": "Dati inseriti non validi. Impossibile moltiplicare due chiavi pubbliche. Seleziona 'Aggiungi' per inserire due chiavi pubbliche ed ottenere l'indirizzo Criptoreal.",
